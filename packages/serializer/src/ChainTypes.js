...
ChainTypes.operations = {
  ...
  blockproducer_create: 20,
  blockproducer_update: 21,
  proposal_create: 22,
  proposal_update: 23,
  proposal_delete: 24,
  ...
  dxpcore_member_create: 29,
  dxpcore_member_update: 30,
  dxpcore_member_update_global_parameters: 31,
  vesting_balance_create: 32,
  vesting_balance_withdraw: 33,
  benefactor_create: 34,
  custom: 35,
  assert: 36,
  balance_claim: 37,
