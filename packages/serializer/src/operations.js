...
export const asset_update_smarttoken_operation_fee_parameters = new Serializer(
  "asset_update_smarttoken_operation_fee_parameters",
  { fee: uint64 }
);
...
export const blockproducer_create_operation_fee_parameters = new Serializer(
  "blockproducer_create_operation_fee_parameters",
  { fee: uint64 }
);

export const blockproducer_update_operation_fee_parameters = new Serializer(
  "blockproducer_update_operation_fee_parameters",
  { fee: int64 }
);
...
export const dxpcore_member_create_operation_fee_parameters = new Serializer(
  "dxpcore_member_create_operation_fee_parameters",
  { fee: uint64 }
);

export const dxpcore_member_update_operation_fee_parameters = new Serializer(
  "dxpcore_member_update_operation_fee_parameters",
  { fee: uint64 }
);

export const dxpcore_member_update_global_parameters_operation_fee_parameters =
  new Serializer(
    "dxpcore_member_update_global_parameters_operation_fee_parameters",
    { fee: uint64 }
  );
...
export const benefactor_create_operation_fee_parameters = new Serializer(
  "benefactor_create_operation_fee_parameters",
  { fee: uint64 }
);
...
export const signed_block = new Serializer("signed_block", {
  ...
  blockproducer: protocol_id_type("blockproducer"),
  transaction_merkle_root: bytes(20),
  extensions: set(future_extensions),
  blockproducer_signature: bytes(65),
...
export const smarttoken_options = new Serializer("smarttoken_options", {
...
export const asset_create = new Serializer("asset_create", {
  ...
  smarttoken_opts: optional(smarttoken_options),
...
export const asset_update_smarttoken = new Serializer("asset_update_smarttoken", {
  fee: asset,
  issuer: protocol_id_type("account"),
  asset_to_update: protocol_id_type("asset"),
  new_options: smarttoken_options,
  extensions: set(future_extensions),
});
...
export const blockproducer_create = new Serializer("blockproducer_create", {
  fee: asset,
  blockproducer_account: protocol_id_type("account"),
  url: string,
  block_signing_key: public_key,
});

export const blockproducer_update = new Serializer("blockproducer_update", {
  fee: asset,
  blockproducer: protocol_id_type("blockproducer"),
  blockproducer_account: protocol_id_type("account"),
...
export const dxpcore_member_create = new Serializer(
  "dxpcore_member_create",
  {
    fee: asset,
    dxpcore_member_account: protocol_id_type("account"),
    url: string,
  }
);

export const dxpcore_member_update = new Serializer(
  "dxpcore_member_update",
  {
    fee: asset,
    dxpcore_member: protocol_id_type("dxpcore_member"),
    dxpcore_member_account: protocol_id_type("account"),
    new_url: optional(string),
  }
);
...
export const chain_parameters = new Serializer("chain_parameters", {
  ...
  dxpcore_proposal_review_period: uint32,
  ...
  maximum_blockproducer_count: uint16,
  maximum_dxpcore_count: uint16,
  ...
  blockproducer_pay_per_block: int64,
  benefactor_budget_per_day: int64,
...
export const dxpcore_member_update_global_parameters = new Serializer(
  "dxpcore_member_update_global_parameters",
  {
    fee: asset,
...
export const refund_benefactor_initializer = new Serializer(
  "refund_benefactor_initializer"
);

export const vesting_balance_benefactor_initializer = new Serializer(
  "vesting_balance_benefactor_initializer",
  { pay_vesting_period_days: uint16 }
);

export const burn_benefactor_initializer = new Serializer(
  "burn_benefactor_initializer"
);

var benefactor_initializer = static_variant([
  refund_benefactor_initializer,
  vesting_balance_benefactor_initializer,
  burn_benefactor_initializer,
]);

export const benefactor_create = new Serializer("benefactor_create", {
  fee: asset,
  owner: protocol_id_type("account"),
  ...
  name: string,
  url: string,
  initializer: benefactor_initializer,
});
...
export const restriction = new Serializer("restriction", {
  ...
  argument: static_variant([
    ...
    protocol_id_type("dxpcore_member"),
    protocol_id_type("blockproducer"),
    ...
    set(protocol_id_type("dxpcore_member")),
    set(protocol_id_type("blockproducer")),
    ...
    set(protocol_id_type("benefactor")),
...
operation.st_operations = [
  ...
  asset_global_settle,
  asset_publish_feed,
  blockproducer_create,
  blockproducer_update,
  proposal_create,
  proposal_update,
  proposal_delete,
  withdraw_permission_create,
